      ...
      <div class="container">
        <div class="row">
          <div class="col-12 col-lg-8 offset-lg-2">
            <div class="card login_card shadow-sm p-3 p-lg-5">
              <div class="row">
                <div
                  class="col-md-6 d-flex align-items-center order-2 order-lg-1 mt-5 mt-lg-0"
                >
                  <div class="login_card_form">
                    <form>
                      <div class="form-row">
                        ...
                        <div
                          class="form-group col-md-12 login_card_form_forgot_password"
                        >
                          <a href="password-email.php">Forgotten password?</a>
                        </div>
                        <div
                          class="form-group col-md-12 login_card_form_create_account"
                        >
                ...
                <div class="col-md-6 order-1 order-lg-2">
                  <div class="login_card_image">
                    <img
                      src="images/register/register.jpeg"
                      class="card-img"
                      alt="register"
                    />
                  </div>
