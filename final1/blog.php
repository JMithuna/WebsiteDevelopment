      ...
      <div class="container">
        <div class="row">
          <div class="col-12 col-lg-8">
            <!-- comment form -->
            <div class="blog_datail_comments_form">
              <h2>Leave A blog post</h2>
              <form method="POST">
                <div class="form-row">
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <textarea name="blog_content" class="form-control" rows="4" required></textarea>
                  </div>
                </div>
                <button name="new_blogpost" class="btn btn-primary">Send</button>
              </form>
            ...
            <br><br>
            <div class="blog_main_sidebar_details">
              <div class="blog_detail">
                  <?php foreach($blog_query as $bq) {?>
                <div class="card blog_detail_card">
                  <div class="card-body blog_detail_card_body">
                    <h2 class="text-capitalize"><?php echo $bq['blog_title'];?></h2>
                    <p class="text-justify">
                    </p>
                    <div
                      class="blog_detail_card_body_title_top d-flex justify-content-between"
                    >
                      <p><?php echo $bq['blog_content'];?></p>
                    </div>
                  </div>
                  <div
                    class="card-footer blog_detail_card_footer d-flex flex-column flex-lg-row justify-content-between"
                  >
                      <a href="./blog/viewblog.php?id=<?php echo $bq['blog_id'];?>"><input class="btn btn-primary" type="button" value="Read More"></a>
                  </div>
                  <?php }?>
                </div>
              </div>
