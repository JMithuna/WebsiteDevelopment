      ...
      <div class="container">
        <div class="row">
          <div class="col-12 col-lg-8 offset-lg-2">
            <div class="card register_card p-3 p-lg-5 shadow-sm">
              <div class="row">
                <div class="col-12 col-md-6">
                  <div class="register_card_image">
                    <img
                  ...
                  <div class="register_card_form">
                    <form>
                      <div class="form-row">
                        ...
                        <div
                          class="col-md-12 register_card_form_have_account text-center"
                        >
